...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 2.0, "minX": 0.0, "maxY": 4964.0, "series": [{"data": [[0.0, 4964.0], [300.0, 2.0], [100.0, 31.0], [200.0, 3.0]], "isOverall": false, "label": "创建交易", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 300.0, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 2.8667999999999956, "minX": 1.74766956E12, "maxY": 2.8667999999999956, "series": [{"data": [[1.74766956E12, 2.8667999999999956]], "isOverall": false, "label": "交易创建测试", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.74766956E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.796336676842566, "minX": 1.0, "maxY": 17.88429752066116, "series": [{"data": [[4.0, 5.664705882352938], [8.0, 17.88429752066116], [2.0, 2.7089552238805954], [1.0, 1.796336676842566], [5.0, 6.497005988023955], [3.0, 6.648351648351656], [6.0, 10.224299065420553], [7.0, 11.177842565597667]], "isOverall": false, "label": "创建交易", "isController": false}, {"data": [[2.8667999999999956, 4.783600000000015]], "isOverall": false, "label": "创建交易-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 8.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 7666.666666666667, "minX": 1.74766956E12, "maxY": 26000.0, "series": [{"data": [[1.74766956E12, 7666.666666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.74766956E12, 26000.0]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.74766956E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 4.783600000000015, "minX": 1.74766956E12, "maxY": 4.783600000000015, "series": [{"data": [[1.74766956E12, 4.783600000000015]], "isOverall": false, "label": "创建交易", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.74766956E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 4.775599999999981, "minX": 1.74766956E12, "maxY": 4.775599999999981, "series": [{"data": [[1.74766956E12, 4.775599999999981]], "isOverall": false, "label": "创建交易", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.74766956E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 1.5400000000000007, "minX": 1.74766956E12, "maxY": 1.5400000000000007, "series": [{"data": [[1.74766956E12, 1.5400000000000007]], "isOverall": false, "label": "创建交易", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.74766956E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 1.0, "minX": 348.0, "maxY": 4.0, "series": [{"data": [[532.0, 2.0], [517.0, 2.0], [544.0, 2.0], [584.0, 3.0], [607.0, 3.0], [348.0, 4.0], [404.0, 2.0], [452.0, 1.0], [503.0, 4.0], [509.0, 2.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 607.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 1.0, "minX": 348.0, "maxY": 4.0, "series": [{"data": [[532.0, 2.0], [517.0, 2.0], [544.0, 2.0], [584.0, 3.0], [607.0, 3.0], [348.0, 4.0], [404.0, 2.0], [452.0, 1.0], [503.0, 4.0], [509.0, 2.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 607.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 83.33333333333333, "minX": 1.74766956E12, "maxY": 83.33333333333333, "series": [{"data": [[1.74766956E12, 83.33333333333333]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.74766956E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 83.33333333333333, "minX": 1.74766956E12, "maxY": 83.33333333333333, "series": [{"data": [[1.74766956E12, 83.33333333333333]], "isOverall": false, "label": "400", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.74766956E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 83.33333333333333, "minX": 1.74766956E12, "maxY": 83.33333333333333, "series": [{"data": [[1.74766956E12, 83.33333333333333]], "isOverall": false, "label": "创建交易-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.74766956E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 83.33333333333333, "minX": 1.74766956E12, "maxY": 83.33333333333333, "series": [{"data": [], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [[1.74766956E12, 83.33333333333333]], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.74766956E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
